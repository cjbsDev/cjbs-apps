...
export default function CrisWriteModal({openModal, closeModal, successBarHandleOpen, reloadData, viewData, clearViewData, t}) {
  ...
  const getDivisionDetaiList = async (division) => {
    ...
    res.status === 200 && res.data.success && setDivisionDetailList(res.data.data)
  }
  ...
  //  setLoading(true)
    ...
    if(isOnce){
      ...
      const API = openModal.code ? `/study/update` : `/study/input`

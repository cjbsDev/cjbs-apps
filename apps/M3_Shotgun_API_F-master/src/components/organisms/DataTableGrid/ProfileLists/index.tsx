...
const DynamicRunModal = dynamic(() => import('@components/organisms/RunModal'), {ssr: false});
const DynamicProfileDetail = dynamic(() => import('@components/organisms/ProfileDetail'), {ssr: false});
...
const ProfileLists = () => {
  ...
  return (
    <>
      <ShotgunDataGrid
        title={<GridHeader titleName={'YOUR SHOTGUN PROFILES'} totalCount={data.total} />}
        columns={columns}
        data={filteredData}
      ...
      <DynamicRunModal runOpen={open} onClose={handleClose} selectedData={selectedData} />

      <DynamicProfileDetail open={editModalOpen} onClose={handleEditModalClose} editState={editState} />
